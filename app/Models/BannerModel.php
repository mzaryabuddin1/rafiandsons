...
class BannerModel extends Model
{
    ...
    public const POSITION_CATEGORY_SECTION = 'category_section';
    ...
    public static function positions(): array
    {
        return [
            ...
            self::POSITION_CATEGORY_SECTION => 'Category Section Banner',
        ];
    }
    ...
    public static function recommendedImageSizes(): array
    {
        return [
            ...
            self::POSITION_CATEGORY_SECTION => ['width' => 1200, 'height' => 280, 'label' => '1200 × 280 px'],
        ];
    }
