...
<div class="row wrapper border-bottom white-bg page-heading" style="margin:-15px -15px 20px;padding:15px;">
    ...
    <div class="col-lg-4 text-right"><?php if (!empty($canCreate)): ?><a href="<?= site_url('admin/products/create') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add Product</a><?php endif; ?></div>
</div>
...
var table = AdminApp.createDataTable({
    ...
    renderRow: function (r) {
        var a = '';
        if (canUpdate) a += '<a href="' + ADMIN_BASE + '/products/' + r.id + '/edit" class="btn btn-xs btn-primary" title="Edit"><i class="fa fa-pencil"></i></a> ';
