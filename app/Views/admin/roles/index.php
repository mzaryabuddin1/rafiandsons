...
var table = AdminApp.createDataTable({
    ...
    renderRow: function (r) {
        var a = '';
        if (canUpdate && r.is_super != 1) a += '<button class="btn btn-xs btn-primary btn-edit" data-id="' + r.id + '"><i class="fa fa-pencil"></i></button> ';
...
loadPermissions(function () { table.load(true); });
</script>
<?= $this->endSection() ?>
